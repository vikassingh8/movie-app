...
export default function SearchScreen() {
  ...
  return (
    <View className="flex-1 relative bg-black" >
      ...
      <View className="mx-4 mb-3 mt-12 flex-row p-2 justify-between items-center bg-black  border-gray-600 border-2 rounded-md ">
        <TextInput
          onChangeText={handleTextDebounce}
          placeholder="Search for your Favorite movies"
          placeholderTextColor={"white"}
          className="pb-1 pl-6 flex-1 font-medium text-white tracking-wider "
        />
